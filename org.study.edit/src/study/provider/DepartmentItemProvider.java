...
public class DepartmentItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyPackage.Literals.DEPARTMENT__PROGRAMME);
			childrenFeatures.add(StudyPackage.Literals.DEPARTMENT__COURSE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyPackage.Literals.DEPARTMENT__PROGRAMME,
				 StudyFactory.eINSTANCE.createProgramme()));

		newChildDescriptors.add
			(createChildParameter
				(StudyPackage.Literals.DEPARTMENT__COURSE,
