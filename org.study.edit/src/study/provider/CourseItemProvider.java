...
public class CourseItemProvider 
	...
	protected void addPointsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_points_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_points_feature", "_UI_Course_type"),
				 StudyPackage.Literals.COURSE__POINTS,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Course.class)) {
			...
			case StudyPackage.COURSE__POINTS:
