...
public class StudyPackageImpl extends EPackageImpl implements StudyPackage {
	 ...
	 * @generated
	 */
	private EEnum fallOrSpringEEnum = null;
	 ...
	 */
	@Override
	public EAttribute getCourse_Points() {
	 ...
	 */
	@Override
	public EAttribute getStudyPlan_StudyPlanName() {
	 ...
	 */
	@Override
	public EAttribute getSemester_FallOrSpring() {
	 ...
	 */
	@Override
	public EReference getCourseSlot_MandatoryCourse() {
	 ...
	 */
	@Override
	public EAttribute getCourseSlot_Elective() {
	 ...
	 */
	@Override
	public EEnum getFallOrSpring() {
		return fallOrSpringEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(courseEClass, COURSE__POINTS);
		...
		createEAttribute(studyPlanEClass, STUDY_PLAN__STUDY_PLAN_NAME);
		...
		createEAttribute(semesterEClass, SEMESTER__FALL_OR_SPRING);

		courseSlotEClass = createEClass(COURSE_SLOT);
		createEReference(courseSlotEClass, COURSE_SLOT__MANDATORY_COURSE);
		createEReference(courseSlotEClass, COURSE_SLOT__ELECTIVE_COURSES);
		createEAttribute(courseSlotEClass, COURSE_SLOT__ELECTIVE);

		// Create enums
		programmeCodeEEnum = createEEnum(PROGRAMME_CODE);
		fallOrSpringEEnum = createEEnum(FALL_OR_SPRING);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCourse_Points(), ecorePackage.getEInt(), "points", null, 0, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProgramme_ProgrammeCode(), this.getprogrammeCode(), "programmeCode", null, 0, 1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStudyPlan_StudyPlanName(), ecorePackage.getEString(), "studyPlanName", null, 0, 1, StudyPlan.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSemester_CourseSlot(), this.getCourseSlot(), null, "courseSlot", null, 0, -1, Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSemester_FallOrSpring(), this.getFallOrSpring(), "fallOrSpring", null, 0, 1, Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(courseSlotEClass, CourseSlot.class, "CourseSlot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCourseSlot_MandatoryCourse(), this.getCourse(), null, "mandatoryCourse", null, 0, 1, CourseSlot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCourseSlot_Elective(), ecorePackage.getEBoolean(), "elective", null, 1, 1, CourseSlot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(fallOrSpringEEnum, FallOrSpring.class, "FallOrSpring");
		addEEnumLiteral(fallOrSpringEEnum, FallOrSpring.FALL);
		addEEnumLiteral(fallOrSpringEEnum, FallOrSpring.SPRING);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (semesterEClass,
		   source,
		   new String[] {
			   "constraints", "totalPointsMustBeMoreThan30"
		   });
		addAnnotation
		  (courseSlotEClass,
		   source,
		   new String[] {
			   "constraints", "mandatoryOrNotConstraint"
		   });
	}
	...
	protected void create_1Annotations() {
		...
		addAnnotation
		  (courseSlotEClass,
		   source,
		   new String[] {
			   "mandatoryOrNotConstraint", "if self.elective = true then not self.mandatoryCourse -> notEmpty() else true endif and if self.elective = false then not self.electiveCourses ->notEmpty() else true endif"
		   });
	}
