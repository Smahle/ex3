 ...
 *   <li>{@link study.impl.CourseImpl#getPoints <em>Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CourseImpl extends MinimalEObjectImpl.Container implements Course {
	...
	public void setPoints(int newPoints) {
		...
		points = newPoints;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudyPackage.COURSE__POINTS, oldPoints, points));
	}
